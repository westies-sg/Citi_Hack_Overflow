...
export default function Home() {
  ...
  const [history, setHistory] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Hello! Ask me any questions about Citibank.',
    },
  ]);
  ...
  return (
    <main className='h-screen bg-white p-6 flex flex-col'>
      <div className='flex  justify-between mb-4'>
        <h1 className='items-end text-4xl  text-transparent font-extralight bg-clip-text bg-gradient-to-r from-violet-800 to-fuchsia-500'>
          Citibot
        </h1>
        <Link
